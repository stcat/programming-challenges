...
An "attributed event" is an event that happened chronologically after an impression and is considered to be the consequence of the user having seen an ad. The advertiser and the user of both the impression and the event have to be the same for the event to be considered for attribution.
...
Type | Timestamp | Advertiser ID | User ID | Should it be attributed?
------------- | ------------- | ------------- | ------------- | -------------
